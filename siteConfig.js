module.exports = {
  siteUrl: "https://easy-tours.co.il", // Site domain. Do not include a trailing slash!

  postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

  siteTitleMeta: "easy-tours", // This allows an alternative site title for meta data for pages.
  siteDescriptionMeta:
    "אתר התיירות", // This allows an alternative site description for meta data for pages.

  shareImageWidth: 1000, // Change to the width of your default share image
  shareImageHeight: 523, // Change to the height of your default share image

  shortTitle: "easy-tours", // Used for App manifest e.g. Mobile Home Screen
  ...
  header: {
    navigation: [
      {
        label: "דף הבית",
        url: "https://easy-tours.co.il/",
      },
      {
        label: "יצירת קשר",
        url: "https://easy-tours.co.il/contact",
      },
    ],
  },
  footer: {
    ...
    navigation: [
      ...
      {
        label: "Sitemap",
        url: "https://easy-tours.co.il/sitemap.xml",
      },
